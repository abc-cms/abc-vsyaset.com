...
if ($user['id']!=1) {
	if ($user['access_ftp']==0) die();
}

//die();

// General
$moxieManagerConfig['general.license'] = 'THNX-THNX-THNX-THNX-THNX-THNX-THNX-THNX';
...
//создаем директорию а то ошибка
if (!is_dir($moxieManagerConfig['filesystem.rootpath']))
	mkdir ($moxieManagerConfig['filesystem.rootpath'],0755,true);
...
$moxieManagerConfig['thumbnail.folder'] = '_thumbs';
$moxieManagerConfig['thumbnail.prefix'] = '_';
